...
// Here E should be number or either its subclasses like Integer , Float.

public class WildCard<E extends Number>
{
    private Object[] data;
    ...
    public void getList(List<Number> list){
        // Code Block
        // Here you can only pass arraylist of type number not it's subclasses
    }

    public void getList2(List<? extends Number> list){

        // Here you can pass number with its child/ subclasses.
    ...
    public WildCard(int initialCapacity){
